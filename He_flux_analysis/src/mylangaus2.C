...
void mylangaus2() {
    ...
    TH1D *hVAEnergy = (TH1D*) f->Get("hVAEnergyX_71_5_1");
    ...
    */
    ...
    pllo[0] = 0.5;      pllo[1] = 10.;      pllo[2] = 1.0;          pllo[3] = 1.;
    plhi[0] = 5.;       plhi[1] = 140.;     plhi[2] = 100000.0;     plhi[3] = 10.;

    // Return values
    double fp[4], fpe[4];
    double chisqr;
    int ndf;
    TF1 *fitVAEnergy = langaufit(hVAEnergy,fr,sv,pllo,plhi,fp,fpe,&chisqr,&ndf);
