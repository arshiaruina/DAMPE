...
int main(int argc, char** argv) {
	...
	//for (int i = 0; i < 10; i++){ // uncomment for debug run
		...
		//stkhelper->SortTracks(0,0); // sorting tracks, trackquality=1,bgomatchcut=false 
		stkhelper->SortTracks(1,0); // sorting tracks, trackquality=1,bgomatchcut=false 
		//stkhelper->SortTracks(2,0); // sorting tracks, trackquality=1,bgomatchcut=false 
		//stkhelper->SortTracks(3,0); // sorting tracks, trackquality=1,bgomatchcut=false 
