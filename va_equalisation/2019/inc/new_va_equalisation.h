...
//    private:
        ...
        TH1F* hVAEnergy[N_LADDER][N_VA][N_ETAREG];
        TH1F* hCumulEnergyAdc;
        TH1F* hCumulEnergy;
        TH1F* hVAEnergyX[N_LADDER/2][N_VA][N_ETAREG];
        TH1F* hVAEnergyY[N_LADDER/2][N_VA][N_ETAREG];
        TH1F* hEnergyAdcLadders[N_LADDER];
        TCanvas* myCanvas[16]; 
